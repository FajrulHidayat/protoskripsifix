          ...
          >
            {level === "operator jurusan" ? (
              <>
                ...
                <Route
                  exact
                  path="/admin/Formproposal"
                  component={FormJudul}
                ></Route>
                <Route
                  exact
                  path="/admin/Formproposal/:id"
                  component={FormJudul}
                ></Route>
                <Route exact path="/admin/hasil" component={Proposal}></Route>
                <Route
                  exact
                  path="/admin/Formhasil"
                  component={FormJudul}
                ></Route>
                <Route
                  exact
                  path="/admin/Formhasil/:id"
                  component={FormJudul}
                ></Route>
                <Route exact path="/admin/kompren" component={Proposal}></Route>
                <Route
                  exact
                  path="/admin/Formkompren"
                  component={FormJudul}
                ></Route>
                <Route
                  exact
                  path="/admin/Formkompren/:id"
                  component={FormJudul}
                ></Route>
                <Route exact path="/admin/tutup" component={Proposal}></Route>
                <Route
                  exact
                  path="/admin/Formtutup"
                  component={FormJudul}
                ></Route>
                <Route
                  exact
                  path="/admin/Formtutup/:id"
                  component={FormJudul}
                ></Route>
