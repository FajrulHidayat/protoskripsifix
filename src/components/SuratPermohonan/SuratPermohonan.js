...
import Docu from './SuratPermohonanPDF'
...
const PDFView = (props) => {
    ...
    const getData = () => {
        ...
        const jenis = props.match.params.jenis
        ...
        axios.get(`/master/${jenis}/${id}`, null, headers).then(res => {
    ...
    return (<>
        {isReady && <PDFViewer width="100%" height="685vh">
            <Docu data={data} jenis={props.match.params.jenis} />
        </PDFViewer>}
