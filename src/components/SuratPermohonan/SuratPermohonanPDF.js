    ...
    return (
        <View style={styles.row}>
            ...
            {props.text1 === "Jurusan/Prodi" ?
                <Text style={[styles.text, { width: "300px" }]} > <Bold font={"arial"} text={props.text3} /></Text>
                : props.text3 === "tanggal" ?
                    <Text style={[styles.text, { width: "300px" }]} > {moment(props.data.waktu).format('dddd,DD MMMM YYYY')}</Text>
                    : props.text3 === "waktu" ?
                        <Text style={[styles.text, { width: "300px" }]} > {`${moment(props.data.waktu).format('HH:mm')} - ${moment(props.data.waktu).add(1, 'hours').format('HH:mm')} Wita`}</Text>
                        :
                        <Text style={[styles.text, { width: "300px" }]} > <Bold font={"arial"} text={props.data.[props.text3]} /></Text>
            }
        </View>
    )
}
    ...
    return (
        <Document>
            <Page size="A4" style={styles.page} wrap={true}>
                ...
                <View>
                    <Text style={[styles.kop, { fontSize: "18pt" }]}>KEMENTERIAN AGAMA REPUBLIK INDONESIA</Text>
                    <Text style={[styles.kop, { fontSize: "14pt" }]}>UNIVERSITAS ISLAM NEGERI ALAUDDIN MAKASSAR</Text>
                    <Text style={[styles.kop, { fontSize: "14pt" }]}>FAKULTAS SAINS & TEKNOLOGI</Text>
                    <Text style={[styles.kop, { fontSize: "14pt" }]}>JURUSAN TEKNIK INFORMATIKA</Text>
                    <Text style={[styles.kop, { fontSize: "8pt" }]}>Kampus I : Jl. Sultan Alauddin Nomor 63 Telp. 864924 (Fax 864923)</Text>
                    <Text style={[styles.kop, { fontSize: "8pt" }]}>Kampus II : Jl. H.M. Yasin Limpo No. 36 Romang Polong Gowa Telp. 1500363, (0411) 841879, Fax 8221400</Text>
                    <Text style={[styles.kop, { fontSize: "8pt" }]}>Website : fst.uin-alauddin.a.id</Text>
                </View>
                ...
                <View style={styles.col}>
                    ...
                    <View style={styles.row}>
                        ...
                        <Text style={[styles.text, { width: "10px" }]}>:</Text>
                        <Text style={[styles.textB, { width: "200px" }]}>{props.jenis === "judul" ?
                            <Bold text={`Permohonan Penerbitan SK Pembimbing Skripsi`} font={"arialB"} />
                            :
                            props.jenis === "proposal" ?
                                <Bold text={`Permohonan Penerbitan SK Seminar Proposal dan Undangan`} font={"arialB"} />
                                :
                                props.jenis === "hasil" ?
                                    <Bold text={`Permohonan Penerbitan SK Seminar hasil dan Undangan`} font={"arialB"} />
                                    :
                                    props.jenis === "tutup" ?
                                        <Bold text={`Permohonan Penerbitan SK Seminar Munaqasyah dan Undangan`} font={"arialB"} />
                                        :
                                        props.jenis === "kompren" ?
                                            <Bold text={`Permohonan Penerbitan SK Seminar Komprehensif`} font={"arialB"} />
                                            :
                                            <Bold text={`Permohonan Penerbitan SK Seminar Proposal dan Undangan`} font={"arialB"} />
                        }</Text>
                    </View>
                ...
                <View style={[{ marginTop: "16px" }]}>
                    <Text style={styles.text}>Dalam rangka penyelesaian Tugas Akhir mahasiswa Fakultas Sains dan Teknologi UIN Alauddin Makassar, maka bersama dengan ini kami memohon kepada Dekan kiranya menerbitkan Surat Keputusan {
                        props.jenis === "judul" ?
                            ...
                            :
                            props.jenis === "proposal" ?
                                <Bold font={"arial"} text={"beserta undanga pelaksanaan Seminar Proposal"} />
                                :
                                props.jenis === "hasil" ?
                                    <Bold font={"arial"} text={"beserta undanga pelaksanaan Seminar Hasil"} />
                                    :
                                    props.jenis === "tutup" ?
                                        <Bold font={"arial"} text={"beserta undanga pelaksanaan Seminar Munaqasyah"} />
                                        :
                                        props.jenis === "kompren" ?
                                            <Bold font={"arial"} text={"pelaksanaa Seminar Komprehensif"} />
                                            :
                                            <Bold font={"arial"} text={"Pembimbing Skripsi"} />
                    } Mahasiswa dibawah ini :</Text>
                </View>
                ...
                <View style={[{ marginTop: "32px" }]}>
                    {
                        ((props.jenis === "hasil") || (props.jenis === "proposal") || (props.jenis === "tutup")) ?
