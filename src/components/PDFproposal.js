...
//         text2:":",
//         point:"a. ",
//         text3:`Bahawa Berdasarkan Surat Permohonan Ketua Jurusan ${props.data.jurusan}untuk membantu kelancaran pelaksanaan penelitian dan penyusunan skripsi mahasiswa tersebut diatas, maka dipandang perlu untuk menerbitkan Surat Keputusan Dekan.`
//     },
//     {
//         text1:"",
//         text2:"",
//         point:"b. ",
//         text3:"Bahwa mereka yang ditetapkan dalam surat keputusan ini dipandang cakap dan memenuhi syarat untuk diserahi tugas sebagai pembimbing penyusun skripsi mahasiswa tersebut diatas."
//     },
//     {
//         text1:"Mengingat",
//         text2:":",
    ...
    if (props.datas.text1 === "pelaksana") {
        ...
        switch (props.datas.point) {
            ...
            case "Sekretaris":
                ...
                break;
            case "Pembimbing 1":
                pelaksana = props.dataSurat.pembimbing1
                break;
            case "Pembimbing 2":
                pelaksana = props.dataSurat.pembimbing2
                break;
            case "Penguji 1":
...
const MyDocument = (props) => {
    ...
    switch (props.data.tentang) {
        case "Proposal":
            ...
            break;
        case "Hasil":
            kopUjian = "DEWAN PENGUJI DAN PELAKSANA UJIAN KUALIFIKASI HASIL"
    ...
    const datas2 = [
        ...
        },
        {
            ...
            text2: "",
            point: "",
            text3: `Menetapkan Dewan Penguji, Pelaksana dan Jadwal Ujian Seminar ${jenisUjian} Fakultas Sains dan Teknologi UIN Alauddin Makassar dengan komposisi :`
        },
        {
            text1: "pelaksana",
            text2: ":",
        ...
        },
        {
            ...
            text2: ":",
            point: "",
            text3: "Tugas Penguji Proposal dan Pelaksana :"
        },
        {
            text1: "",
            text2: "",
            point: "a. ",
            text3: "Ketua adalah memimpin dan membuka sidang ujian Proposal."
        },
        {
            text1: "",
            text2: "",
        ...
        },
        {
            ...
            text2: "",
            point: "c. ",
            text3: "Pembimbing adalah menghadiri dan mendampingi Mahasiswa dalam pelaksanaan ujian Proposal."
        },
        {
            text1: "",
            text2: "",
            point: "d. ",
            text3: "Penguji adalah menguji Mahasiswa dalam Pelaksanaan ujian Proposal."
        },
        {
            text1: "",
            text2: "",
            point: "e. ",
            text3: "Pelaksana adalah mempersiapkan segala sesuatu yang berkaitan dengan pelaksanaan ujian Proposal."
        },
        {
            text1: "KETIGA",
            text2: ":",
            point: "",
            text3: `Ujian Proposal Penelitian dilaksanakan pada hari dan tanggal: ${moment(props.data.waktu).format('dddd, DD MMMM YYYY')}, Jam 09.00 - 10.00 Wita, Bertempat di Ruang Jurusan ${props.data.jurusan}`
        },
        {
            text1: "KEEMPAT",
            text2: ":",
